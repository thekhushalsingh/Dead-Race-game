...
pygame.display.set_caption('DEAD RACE')
...
menubg = pygame.image.load('img/background/Graveyard.jpeg').convert_alpha()
...
pine1_img = pygame.image.load(
    'img/background/2_background_NEST/pxfuel.jpg').convert_alpha()
pine2_img = pygame.image.load(
    'img/background/2_background_NEST/pxfuel.jpg').convert_alpha()
mountain_img = pygame.image.load('img/background/2_background_NEST/pxfuel.jpg').convert_alpha()
...
#MUSIC
menumusic = pygame.mixer.music.load('audio/introo.mp3')
...
DEAD_RACE = pygame.font.Font("font/Futurot.ttf", 130)
BTNtext = pygame.font.Font("font/Futurot.ttf", 50)
YOUDIED = pygame.font.Font("font/Futurot.ttf", 110)
KTEAM = pygame.font.Font("font/Futurot.ttf", 13)
...
class HealthBar():
    ...
    def draw(self, health):
        ...
        draw_text('Current build V2.0 (release.20.2.2023)', ver, WHITE, 5, 853)
...
def settings_show():
        ...
        draw_text('GRENADE', font, WHITE, 55, 546),
...
def info_show():
        ...
        draw_text('In DEAD RACE you have to survive the zombie', LORE, WHITE, 680, 350)
...
while run:
    ...
    if start_game == False:
        ...
        draw_text('DEAD RACE', DEAD_RACE, WHITE, 180, 125)
        draw_text('@2023', KTEAM, WHITE, 905, 845)
        draw_text('Current build V2.0 (released.21.2.2023)', ver, WHITE, 5, 845)
